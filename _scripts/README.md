...
and Team profile creation. `System` holds Daily, Tasks, and the two startup refreshes.
Use native daily-note tooling for normal daily access; QuickAdd Daily is a secondary utility.
